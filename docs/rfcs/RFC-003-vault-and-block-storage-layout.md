...
- **Status:** Living (accepted 2026-08-05; Phase 2 active — amendments during phase land in place per §12 lifecycle; amended same day after adversarial review: dump/restore contract, RLS trust model, FK topology, splice semantics, resolution repair)
- **Phase:** 2
...
- **RLS is not enabled by default.** The documented one-policy pattern (a Phase 2 deliverable, verified by the gate) is:
